...
min_corr = 0.2 #try to explore a little bit to find the best value
...
for k in range(0,reps):
    ...
    #Commented above a non-linear SVM-reg
    # regr = svm.SVR(max_iter = 10000, C = 1, kernel = 'poly', degree = 2, epsilon = 0.0001) #2
    
    #5-fold cross validation
    cv = StratifiedKFold(n_splits = n_splits, shuffle = True, random_state = k)
